...
export const value = (input: unknown) =>
    input === null || input === undefined || input === ''
        ? 'Не указано'
        : String(input);
export const priorityText = (priority?: Priority) =>
    ({ low: 'Низкий', normal: 'Обычный', high: 'Высокий', urgent: 'Срочный' })[
        priority || 'normal'
    ];
export const registrationStatus = (item: Registration) =>
...
export const answerLabels: Record<string, string> = {
    paymentProof: 'Платёжное поручение',
