...
$env:DB_PORT = '55436'
$env:DB_NAME = 'vitma_fe1a_application'
$env:DB_USER = 'vitma_fe1a'
$env:DB_PASS = 'fe1a_local_test_only'
$env:TEST_DB_HOST = $env:DB_HOST
$env:TEST_DB_PORT = $env:DB_PORT
$env:TEST_DB_NAME = 'vitma_fe1a_test'
$env:TEST_DB_USER = $env:DB_USER
$env:TEST_DB_PASS = $env:DB_PASS
$env:FILE_STORAGE_ROOT = Join-Path ([System.IO.Path]::GetTempPath()) 'vitma-fe1a-storage'
